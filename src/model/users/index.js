...
const postUsers = async (body, hashedPassword) => {
    const { name, email, cpf, rg, tel, data_nasc } = body;
    ...
    `;
    const values = [name, hashedPassword, email, cpf, rg, tel, data_nasc, createdAt];
...
const deleteUsers = async (id) => {
    ...
    //2- deletar a os débitos do usuário
